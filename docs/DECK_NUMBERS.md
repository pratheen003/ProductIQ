...
| **Performance** | Automated Processing Throughput | **7,891.4 rows/sec** | 126.7 ms for 1,000 rows |
...
- **Total Processing Time:** 126.72 ms
- **Throughput:** 7,891.4 items/second (0.127 ms/item)
