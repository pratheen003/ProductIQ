...
const COLORS: Record<string, string> = {
  ...
  VERIFIED: "#16A34A",
  INFERRED: "#D97706",      // Amber
  UNVERIFIED: "#D97706",
  CONFLICTED: "#DC2626",    // Red
  REVIEW_REQUIRED: "#F59E0B",
  UNKNOWN: "#6B7280",       // Gray
  UNSUPPORTED: "#9333EA",   // Purple
  MISSING: "#9CA3AF",
};
      ...
      <div className="flex items-center justify-between pb-3 border-b border-gray-100">
        <div>
          <h4 className="font-sans font-bold text-gray-900 text-sm">
            Product Trust Status Distribution
          </h4>
          <p className="text-xs text-gray-500 font-sans mt-0.5">
            Truth tier segmentation across all {total} dataset motors
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="w-full sm:w-1/2 h-44 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            ...
            <span className="font-sans text-[10px] text-gray-400 uppercase">Motors</span>
          </div>
        </div>
